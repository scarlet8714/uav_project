...
# base_camera.set(cv2.CAP_PROP_AUTO_EXPOSURE, 0.25)

# # 設定手動曝光值
# base_camera.set(cv2.CAP_PROP_EXPOSURE, -5)

# # 關掉自動白平衡
# base_camera.set(cv2.CAP_PROP_AUTO_WB, 0)

# # 設定手動白平衡
# base_camera.set(cv2.CAP_PROP_WB_TEMPERATURE, 4500)
